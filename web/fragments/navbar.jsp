...
<%
	...
	Amministratore a = (Amministratore)session.getAttribute("amministratore");
	if(u != null) { 
%> 
	<!-- utente loggato -->
	<div class="container">
	...
	<div class="container">
	    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
	      <div class="col-md-3 mb-2 mb-md-0">
	        <a href="/ChooseYourShow/pages/homepage_pubblicatore.jsp" class="d-inline-flex link-body-emphasis text-decoration-none">
	        	<img src="/ChooseYourShow/images/thanos-gangnam-style.gif" alt="mdo" width="48" height="48"></img>
	        	<span>CYS-Amministratori</span>
	        </a>
	      </div>
	
	      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
	        <li><a href="/ChooseYourShow/pages/homepage_amministratore.jsp" class="nav-link px-2 link-secondary">Home</a></li>
	        <li><a href="/ChooseYourShow/pages/revisiona_spettacoli.jsp" class="nav-link px-2">revisiona</a></li>
	        <li><a href="#" class="nav-link px-2">approva pubblicatori</a>
	      </ul>
	    </header>
	</div>
<%
